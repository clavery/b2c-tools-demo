...
async function codeDeploy(reload = false, cartridges) {
...
async function codeDownload(outputDir, cartridges, mirror = false) {
...
module.exports = {
    ...
    builder: (yargs) => yargs
        .command('deploy', 'deploy cartridges to code version',
            ...
            async (argv) => await codeDeploy(argv.reload, argv.cartridge)
        )
        .command('download', 'download cartridges from code version',
            ...
            async (argv) => await codeDownload(argv.output, argv.cartridge, argv.mirror)
        )
        .demandCommand()
};
